...
class Produk_retail_model extends CI_Model
{
    ...
    function json_new($id_toko, $id_users = '')
    {
        $this->datatables->select('pr.id_produk, pr.id_produk_2, pr.id_toko, pr.barcode, pr.id_kategori, pr.nama_produk, pr.deskripsi, pr.harga_1, pr.harga_2, pr.harga_3, s.satuan, pr.berat, pr.mingros, pr.diskon, pr.rak, pr.dibeli, pr.gambar, k.nama_kategori, b.harga_satuan AS harga_beli, sup.nama_supplier');
