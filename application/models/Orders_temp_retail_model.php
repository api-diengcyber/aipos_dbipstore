...
class Orders_temp_retail_model extends CI_Model {
    ...
    {
        $this->db->select('ot.*, p.deskripsi, p.id_produk_2 AS produk_id, p.id_produk_2, p.barcode, p.nama_produk, p.harga_1, p.harga_2, p.harga_3, p.harga_4, p.harga_5, p.harga_6, p.diskon AS diskon_produk, p.mingros, p.dibeli');
