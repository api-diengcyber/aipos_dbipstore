...
class Pembelian_retail_model extends CI_Model
{
    ...
    function json_faktur($id_toko, $id_faktur)
    {
        ...
        $this->datatables->from('pembelian p');
        $this->datatables->join('users u', 'p.id_users=u.id_users AND p.id_toko=u.id_toko');
        $this->datatables->join('produk_retail', 'p.id_produk=produk_retail.id_produk_2 AND produk_retail.id_toko=p.id_toko');
        $this->datatables->join('supplier', 'p.id_supplier=supplier.id_supplier AND supplier.id_toko=p.id_toko');
        $this->datatables->where('p.id_toko', $this->userdata->id_toko);
        // $this->datatables->where('u.id_cabang', $this->userdata->id_cabang);
    ...
    {
        $this->datatables->select('produk_retail.id_produk_2,pembelian.id, pembelian.id_pembelian, pembelian.id_toko, pembelian.id_faktur, pembelian.id_produk, pembelian.tgl_masuk, pembelian.tgl_expire, pembelian.id_supplier, pembelian.pembayaran, pembelian.harga_satuan,jumlah, pembelian.total_bayar, produk_retail.nama_produk, supplier.nama_supplier, faktur_retail.no_faktur');
        $this->datatables->from($this->table);
        $this->datatables->join('users u', 'pembelian.id_users=u.id_users AND pembelian.id_toko=u.id_toko');
        $this->datatables->join('produk_retail', 'pembelian.id_produk=produk_retail.id_produk_2 AND produk_retail.id_users=u.id_users AND produk_retail.id_toko=pembelian.id_toko');
        $this->datatables->join('supplier', 'pembelian.id_supplier=supplier.id_supplier AND supplier.id_users=u.id_users AND supplier.id_toko=pembelian.id_toko');
        $this->datatables->join('faktur_retail', 'pembelian.id_faktur=faktur_retail.id_faktur AND faktur_retail.id_users=u.id_users AND faktur_retail.id_toko=pembelian.id_toko');
    ...
    {
        $this->db->select('produk_retail.barcode,produk_retail.id_produk_2,pembelian.id, pembelian.id_pembelian, pembelian.id_toko, pembelian.id_faktur, pembelian.id_produk, pembelian.tgl_masuk, pembelian.tgl_expire, pembelian.id_supplier, pembelian.pembayaran, pembelian.harga_satuan,jumlah, pembelian.total_bayar, produk_retail.nama_produk, supplier.nama_supplier, faktur_retail.no_faktur');
        $this->db->from($this->table);
        $this->db->join('users u', 'pembelian.id_users=u.id_users AND pembelian.id_toko=u.id_toko');
        $this->db->join('produk_retail', 'pembelian.id_produk=produk_retail.id_produk_2 AND produk_retail.id_users=u.id_users AND produk_retail.id_toko=pembelian.id_toko');
        $this->db->join('supplier', 'pembelian.id_supplier=supplier.id_supplier AND supplier.id_users=u.id_users AND supplier.id_toko=pembelian.id_toko', 'left');
        $this->db->join('faktur_retail', 'pembelian.id_faktur=faktur_retail.id_faktur AND faktur_retail.id_users=u.id_users AND faktur_retail.id_toko=pembelian.id_toko');
        $this->db->where('pembelian.id_toko', $this->userdata->id_toko);
