<div class="main-content">
  <div class="main-content-inner">
    ...
    <div class="page-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <iframe src="<?php echo $cetak ?>" id="ppreview"
            style="width: 100%; height: 450px;position:relative; z-index:999"></iframe>
          <br><br>
          <div id="preview-pane" style="width: 100%; height: 850px;position:relative; z-index:999">
            <embed class="pdfobject" src="" type="application/pdf" style="overflow: auto; width: 100%; height: 100%;"
              internalinstanceid="17">
          </div>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.page-content -->
...
<script src="<?php echo base_url() ?>assets/js/pdfobject.min.js" type="text/javascript"></script>
<script>
  var no = 1;
  jQuery(function ($) {
    $("#navbar").remove();
    ...
    setTimeout(function () {
      ...
      pdf.addHTML($("#ppreview"), function () {
        var string = pdf.output('datauristring');
        $('#preview-pane embed').attr("src", string);
      });
    }, 5000);
