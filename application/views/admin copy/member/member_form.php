        ...
        <div class="col-xs-12">
          ...
          <form action="<?php echo $action; ?>" method="post">
            <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-addon" style="padding:0px;margin:0px;border:0px;">
                        <input type="text" class="form-control" name="custom_code" value="00" style="width:50px;"
                          maxlength="3" />
                      </span>
                    </div>
                  </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="varchar">Pilihan Harga
                    <?php echo form_error('id_pil_harga') ?>
                  </label>
                  <select class="form-control" name="id_pil_harga" id="id_pil_harga">
                    <option value="1" <?php echo $id_pil_harga == "1" ? "selected" : "" ?>>Harga 1</option>
                    <option value="2" <?php echo $id_pil_harga == "2" ? "selected" : "" ?>>Harga 2</option>
                    <option value="3" <?php echo $id_pil_harga == "3" ? "selected" : "" ?>>Harga 3</option>
                    <option value="4" <?php echo $id_pil_harga == "4" ? "selected" : "" ?>>Harga 4</option>
                    <option value="5" <?php echo $id_pil_harga == "5" ? "selected" : "" ?>>Harga 5</option>
                    <option value="6" <?php echo $id_pil_harga == "6" ? "selected" : "" ?>>Harga 6</option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group panelPersenPajak" style="display:none;">
                  ...
                  <input type="text" class="form-control" name="persen_pajak" id="persen_pajak"
                    placeholder="Faktur Pajak (%)" value="<?php echo $persen_pajak; ?>" />
                </div>
                <!-- <div class="form-group">
                  <label for="varchar">Akun Piutang</label>
                  <select class="form-control" name="uid_akun" id="uid_akun">
                    <option value="">-- Pilih Akun --</option>
                    <?php foreach ($data_akun as $key): ?>
                      <option value="<?php echo $key->uid ?>" <?php echo $uid_akun == $key->uid ? "selected" : "" ?>>
                        <?php echo $key->kode . ". " . $key->akun ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
                </div>
                <div class="form-group">
                  <label for="varchar">Gudang</label>
                  <select class="form-control" name="id_gudang" id="id_gudang">
                    <option value="">-- Pilih Gudang --</option>
                    <?php foreach ($data_gudang as $key): ?>
                      <option value="<?php echo $key->id ?>" <?php echo $id_gudang == $key->id ? "selected" : "" ?>>
                        <?php echo $key->nama_gudang ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
                </div> -->
            ...
            <div class="row" style="margin-top: 20px;">
              <div class="col-xs-12 text-center">
                ...
                <a href="<?php echo site_url('admin/member_retail') ?>" class="btn btn-default">Cancel</a>
              </div>
            </div>
          </form>
