							...
							<tbody>
								...
								foreach ($penjualan as $p) { ?>
									<tr>
										...
										<td>
											<?php if ($p->total_bayar != null) { ?>
												<p>
													Total Penjualan
												</p>
												<!-- <?= number_format($p->total_bayar) ?> -->
											<?php } ?>
											<?php if ($p->total_laba != null) { ?>
												<p>
													Laba Penjualan Bersih
												</p>
												<!-- <?= number_format($p->total_laba) ?> -->
											<?php } ?>
									...
									<?php $jml_penjualan_masuk += $p->total_bayar;
									...
									<tr>
										...
										<td>
											...
											if ($nama_karyawan != null) {
												echo "Beban Karyawan " . $nama_karyawan->first_name . " " . $nama_karyawan->last_name;
											} else {
												echo "Beban " . $b->nama;
											}
							...
							<tfoot>
								<tr>
									...
									<th class="text-right"><span id="jumlah_pemasukkan"></span>
										<?= number_format($jml_masuk + $jml_laba_masuk + $jml_penjualan_masuk) ?>
									</th>
								...
								<tr>
									...
									<th class="text-right" colspan="2"><span id="total">
											<?= number_format($total_all = ($jml_masuk + $jml_laba_masuk + $jml_penjualan_masuk) - ($jml_keluar + $jml_beban_keluar)) ?>
										</span></th>
								</tr>
								<!-- <tr>
									<th class="text-right" colspan="4">TOTAL BERSIH </th>
									<th class="text-right" colspan="2"><span id="total">
											<?= number_format($total_all - $jml_beban_keluar) ?>
										</span></th>
								</tr> -->
