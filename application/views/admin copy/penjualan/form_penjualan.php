          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group" style="margin-top:28px;">
                ...
                <h2 style="color:black;font-weight:bold;font-family:impact;margin-top:0px;">&nbsp;Rp. <span style="float:right;"><span class="total">0</span>,- </span></h2>
                            ...
                            <div class="col-sm-10">
                              <div class="row">
                                ...
                                <div class="col-sm-6"> Potongan<div class="input-group"><input type="text" class="form-control" name="mdl_touch_ubah_pot" id="mdl_touch_ubah_pot">
                                    <div class="input-group-addon numpad-potongan2 numpad"><i class="fa fa-table"></i></div>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    if (pembayaran == 5) {
        ...
        $(".panelDeadline").addClass("hide");
        $(".panelSplitNominal").addClass("d-none");
        $(".nominal-split2-form").addClass("hide");
      } else {
