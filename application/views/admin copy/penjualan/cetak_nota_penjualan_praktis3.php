...
<body style="padding:10px;" onload="print()" class="ppt">
	...
	<table>
		<tr>
			<!-- <td style="padding-left:10px;"><img src="<?php echo base_url() ?>assets/images/logo_carica.png"
					height="60px" alt=""></td> -->
			<td style="vertical-align: top; padding-left:10px;">
				<h3 style="margin-left:0px;margin-right:0px;margin-bottom:5px;margin-top:0px">
	...
	<table style='margin-top:5px; float:right; margin-top: -100px; margin-right: 30px;'>
		<tr>
	...
	<table style="border-collapse:collapse;width:95vw">
		<thead style="border-bottom:solid 1px black" align="left">
			...
			<th width="50" align="right">Disc </th>
		...
		<tbody>
			...
			foreach ($orders_detail as $key):
				...
				<tr style="border-bottom:solid 1px black">
					...
					<td align="right">
						<?php echo number_format($key->subtotal, 0, ',', '.') ?>
					</td>
				</tr>
				<?php
				$no++;
					...
					<table style="width:100%">
						...
						<?php if ($piutang) { ?>
							<tr>
								...
								<td>:</td>
								<td align="right">
									<?php echo number_format($piutang->jumlah_bayar, 0, ',', '.') ?>
								</td>
							</tr>
							<tr>
								<td>Kurang</td>
								<td>:</td>
								<td align="right">
									<?php echo number_format($piutang->sisa, 0, ',', '.') ?>
								</td>
							</tr>
						<?php } ?>
						<tr>
							...
							<td>:</td>
							<td align="right">
								<?php echo $orders->diskon_member * 1 ?>%
							</td>
						</tr>
						<!-- <tr>
							<td>PPN</td>
