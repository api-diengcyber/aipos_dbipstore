    ...
    <div class="navbar-container ace-save-state" id="navbar-container">
      ...
      <div class="navbar-header pull-left">
        <a href="" class="navbar-brand">
          <small>
            <img class="nav-user-photo" src="<?php echo base_url() ?>assets/images/logo.png" width="30"
              style="margin:0px;" alt="">
            &nbsp;&nbsp;
            <?php echo !empty($nama_toko) ? $nama_toko : "Nama Toko";
            echo !empty($this->userdata->nama_cabang) ? " " . $this->userdata->nama_cabang : ""; ?>
          </small>
        </a>
      </div>
                  ...
                  <li>
                    <a href="#">
                      <button type="button" class="btn btn-xs btn-block btn-primary"
                        onclick="popup('https://m.me/aiposretailrestaurant');">
                        <i class="ace-icon fa fa-facebook bigger-110"></i>
                        <b>Chat Facebook</b>
                      </button>
                      <button type="button" class="btn btn-xs btn-block btn-success" onclick="t_wa();">
