      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="row" style="margin-bottom: 10px;">
            <div class="col-md-4">
              <a href="<?php echo base_url() ?>admin/laporan_retail/cetak_stok_produk" target="_blank"
              ...
              <tbody>
                ...
                foreach ($contents as $key):
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo $key->satuan_produk ?>
                    </td>
                    <td>Rp <span style="float:right;">
                        <?php echo number_format($key->harga_1, 0, ',', '.') ?>
                      </span></td>
                    <td>Rp <span style="float:right;">
                        <?php echo number_format($key->harga_2, 0, ',', '.') ?>
                      </span></td>
                    <td>Rp <span style="float:right;">
                        <?php echo number_format($key->harga_3, 0, ',', '.') ?>
                      </span></td>
