              ...
              <div class="col-md-6">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <div class="form-group">
                      <label for="">Suplier <?php echo form_error('suplier') ?></label>
                      
                      <select class="form-control" name="supplier" id="supplier">
                              <option value="" selected disabled>-- Pilih Supplier --</option>
                            <?php foreach ($data_supplier as $key): ?>
                              <option value="<?php echo $key->id_supplier ?>" <?php if($key->id_supplier==$data_supplier_select){echo "selected";}?>><?php echo $key->nama_supplier ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                    <div class="form-group">
                      <?php 
                      if($parent==null){?>
                        <label for="bigint">IMEI <?php echo form_error('barcode') ?>
                        <!-- <a href="<?php echo base_url('admin/produk_retail/create?id_barcode=1'); ?>">(Buat Barcode)</a> -->
                      </label> 
                         <input type="text" class="form-control" name="barcode" id="barcode" placeholder="IMEI" value="<?php echo $barcode; ?>" />
                      <?php
                      }else{?>
                            <label for="bigint">IMEI <?php echo form_error('barcode') ?></label> 
                            <input type="text" class="form-control" name="barcode" id="barcode" placeholder="IMEI" value="<?php echo $parent->barcode; ?>" />
                      <?php                        
                        }
                      ?>                       
                    ...
                    <?php 
                      if($parent!=null){?>
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="parent_id" id="barcode" placeholder="Barcode" value="<?php echo $parent->nama_produk; ?>" readonly/>
                        ...
                        <select class="form-control" name="kategori" id="kategori" />
                          <option value="" disabled>-- Pilih Kategori --</option>                         
                            ...
                            foreach ($data_kategori->result() as $key):
                              ...
                              ?>
                                <option selected value="<?php echo $key->id_kategori_2 ?>"><?php echo " - ".$key->nama_kategori ?></option>
                              <?php } else { ?>
                                <option value="<?php echo $key->id_kategori_2 ?>"><?php echo " - ".$key->nama_kategori ?></option>
                              <?php } ?>
                            <?php endforeach ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" name="hpp" id="hpp" placeholder="HPP Awal" value="<?php echo $hpp_awal ?>" />
                </div>
              </div>
            </div>
