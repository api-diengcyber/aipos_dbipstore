          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <form action="<?php echo base_url() ?>admin/pembelian/create_action" method="post" class="form-pembelian">
                        ...
                        <!-- <div class="col-xs-2">
                          <div class="form-group">
                            ...
                            //foreach ($data_cabang as $key): ?>
                              <option value="<?php //echo $key->id_users ?>" <?php //echo $key->first_name.''.$key->last_name=="GUDANGPUSAT"?"selected":"" ?>><?php //echo $key->first_name.' '.$key->last_name ?></option>
                            <?php //endforeach ?>
                            </select>
                          </div>
                        </div> -->
