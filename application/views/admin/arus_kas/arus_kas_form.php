        ...
        <div class="col-xs-12">
          ...
          <form action="<?php echo $action; ?>" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="tgl" id="datepicker1" placeholder="dd-mm-yyyy" readonly
                value="<?php echo $tgl; ?>" />
            </div>
            <div class="form-group">
              <label for="varchar"><span id="nama_kas">
                  <?php echo $nama_kas ?>
                </span>
              ...
              <select class="form-control" name="id_akun" id="id_akun">
                <?php foreach ($data_akun as $key): ?>
                  <?php if ($key->id_akun == $id_akun) { ?>
                    <option selected value="<?php echo $key->id_akun ?>">
                      <?php echo $key->nama_akun ?>
                    </option>
                  <?php } else { ?>
                    <option value="<?php echo $key->id_akun ?>">
                      <?php echo $key->nama_akun ?>
                    </option>
                  <?php } ?>
                <?php endforeach ?>
