            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tgl" id="datepicker2" placeholder="dd-mm-yyyy"
                    value="<?php echo $tgl; ?>" autocomplete="off" />
                </div>
              </div>
              <div class="col-md-8">
                <div class="form-group">
                  <label for="varchar">Faktur Pembelian
...
<script type="text/javascript">
  ...
  var get_produk = function (id_faktur) {
    $('button[type="submit"]').attr("disabled", "disabled");
    $.ajax({
      url: '<?php echo base_url() ?>admin/retur/produk_ajax/' + id_faktur,
      type: 'GET',
