...
<body onload="<?php if ($print == '1') {
	...
	<div style="margin:0px;padding:0px;">
		...
		<div style="display: inline-block; width:100%;">
			...
			<div style="float:right;text-align:right;font-size:16px;">
		...
		<div style="text-align:left;">
			<table style="width:100%;">
				...
				<tr>
					...
					<td></td>
					<td></td>
					<td rowspan="3" style="vertical-align:top;text-align:right;font-size:19px;"><?php echo $nama_pembeli ?></td>
				</tr>
				<?php if ($piutang) { ?>
					<tr>
						<td>Jatuh Tempo</td>
		...
		<table id="panelBarang">
			...
			<?php if ($opsi_diskon == 1) {
				if (isset($pembeli->diskon)) {
					...
					echo '<tr>
						<th colspan="2"><span style="float:right;">Diskon Member</span></th>
