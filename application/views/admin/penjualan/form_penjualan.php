  ...
  <div class="main-content-inner">
    ...
    <div class="page-content" id="fullscreen">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="row">
                <div class="col-xs-4">
                  <div class="form-group">
                    <label for="varchar"><b>Tgl Order</b>
                      <?php echo form_error('tgl_order') ?>
                    </label>
                    <input type="text" name="tgl" class="form-control input-2" id="tampil_tgl_order"
                      placeholder="Tgl Order" value="<?php echo $tgl_order; ?>" readonly />
                  </div>
                </div>
                <div class="col-xs-4" style="padding-left:0px;">
                  <div class="form-group">
                    <label for="varchar"><b>No Faktur</b>
                      <?php echo form_error('no_faktur') ?>
                    </label>
                    <input type="text" class="form-control input-2" id="tampil_no_faktur" placeholder="No Faktur"
                      value="<?php echo $no_faktur; ?>" readonly />
                  </div>
                </div>
                <div class="col-xs-3" style="padding-left:0px;">
                  <div class="form-group m-switch">
                    ...
                    <select name="id_sales" class="input-2 id_sales <?php echo $class_sales ?>" style="width:100%;"
                      <?php echo $disabled_sales ?>>
                      <option value="">-- Pilih Sales --</option>
                      <?php foreach ($data_sales as $key_s): ?>
                        <option value="<?php echo $key_s->id_users ?>" <?php echo $key_s->id_users == $id_sales ? "selected" : "" ?>>
                          <?php echo $key_s->first_name ?>
                        </option>
                      <?php endforeach ?>
                    </select>
                  </div>
              ...
              <div class="row m-switch">
                ...
                <div class="col-xs-3" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control nama_pembeli input-2" autocomplete="off"
                      value="<?php echo $nama_pembeli ?>" placeholder="Nama Pembeli" />
                  </div>
                </div>
                <div class="col-xs-3" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control alamat_pembeli input-2" autocomplete="off"
                      value="<?php echo $alamat_pembeli ?>" placeholder="Alamat Pembeli" />
                  </div>
                </div>
                <div class="col-xs-3" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control no_hp input-2" autocomplete="off" value=""
                      placeholder="No HP" />
                  </div>
                </div>
            ...
            <div class="col-md-4">
              ...
              <div class="form-group" style="margin-top:28px;">
                ...
                <h4 class="total_asli hide"
                  style="color:black;font-weight:bold;font-family:sans-serif;margin-bottom:0px;"><span
                    class="diskon_member">10%</span> <span style="float:right;text-decoration:line-through;"><span
                      class="total_asli total_asli_value" style="text-decoration:line-through;">0</span>,- </span></h4>
                <h2 style="color:black;font-weight:bold;font-family:impact;margin-top:0px;">&nbsp;<span
                    style="float:right;"><span class="total">0</span>,- </span></h2>
            ...
            <div class="col-md-12 m-switch-mg switch-dropship" style="display:none;">
              <div class="row m-switch">
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control input-2" id="p_nama" placeholder="Nama Pengirim"
                      style="border-color: #0a0;" />
                  </div>
                </div>
                <div class="col-md-2" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control input-2" id="p_alamat" placeholder="Alamat Pengirim"
                      style="border-color: #0a0;" />
                  </div>
                </div>
                <div class="col-md-2" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control input-2" id="p_hp" placeholder="No HP Pengirim"
                      style="border-color: #0a0;" />
                  </div>
                </div>
              </div>
              <div class="row m-switch">
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control input-2" id="d_nama" placeholder="Nama Tujuan"
                      style="border-color: #00a;" />
                  </div>
                </div>
                <div class="col-md-2" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control input-2" id="d_alamat" placeholder="Alamat Tujuan"
                      style="border-color: #00a;" />
                  </div>
                </div>
                <div class="col-md-2" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control input-2" id="d_hp" placeholder="No HP Tujuan"
                      style="border-color: #00a;" />
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-12 m-switch-mg">
              <div class="row m-switch">
                  ...
                  <div class="form-group">
                    <select name="id_media" class="id_media input-2" placeholder="Media" style="width:100%;">
                      ...
                      <?php foreach ($data_media as $key_m): ?>
                        <option value="<?php echo $key_m->id ?>" <?php echo $key_m->id == $id_media ? "selected" : "" ?>>
                          <?php echo $key_m->media ?>
                        </option>
                      <?php endforeach ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group ">
                    <select name="akun_transfer" id="akun_transfer" class="" style="width:100%;">
                      <?php foreach ($data_akun_transfer as $key): ?>
                        <option value="<?php echo $key->kode ?>">
                          <?php echo $key->akun ?>
                        </option>
                      <?php endforeach ?>
                    </select>
                ...
                <div class="col-md-2 panelCOD hide d-none" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control biayacod input-2 text-right numbering"
                      placeholder="Biaya COD" maxlength="11" />
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <select name="id_bank" id="id_bank" class=" input-2" style="width:100%;">
                      ...
                      <?php foreach ($data_bank as $key_b): ?>
                        <option value="<?php echo $key_b->id ?>">
                          <?php echo $key_b->bank ?>
                        </option>
                      <?php endforeach ?>
                    </select>
                ...
                <div class="col-md-2 panelPembayaranLainnya hide" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" name="nominal_transfer"
                      class="form-control text-right numbering input-2 nominal_transfer" placeholder="Nominal Transfer"
                      autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="col-md-2 panelSplit hide" style="padding-left:0px;">
                  <div class="form-group">
                    ...
                    <input type="text" name="nominal_split1" id="split_nominal"
                      class="form-control nominal-split input-2 nominal-split1 numbering" placeholder="Nominal" />
                  </div>
                ...
                <div class="col-md-2 panelSplit hide" style="padding-left:0px;">
                  ...
                  <div class="form-group d-none">
                    <input type="text" name="no_resi" class="form-control input-2 no_resi" placeholder="No Resi"
                      autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="col-md-2 panelSplitDeadline hide" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control deadline input-2 deadline_split" placeholder="Hari ini"
                      maxlength="11" />
                  </div>
                </div>
                <div class="col-md-2 panelSplit nominal-split2 hide">
                  <div class="form-group">
                    ...
                    <input type="text" name="nominal_split2" id="split_nominal"
                      class="form-control input-2 nominal_split_2 numbering hide nominal-split2-form"
                      placeholder="Nominal" value="0" readonly />
                  </div>
                </div>
                ...
                <div class="col-md-2 panelSplitPembayaranLainnya hide" style="padding-left:0px;">
                  <div class="form-group">
                    <select name="id_bank_split" id="id_bank" class="bank_split input-2 id_bank_split"
                      style="width:100%;">
                      <?php foreach ($data_bank as $key_b): ?>
                        <option value="<?php echo $key_b->id ?>">
                          <?php echo $key_b->bank ?>
                ...
                <div class="col-md-2 panelSplitPembayaranLainnya hide" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" name="nominal_split2"
                      class="form-control text-right numbering input-2 nominal_split_2 " placeholder="Nominal Transfer"
                ...
                <div class="col-md-2 d-none" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" name="ongkir" class="form-control text-right input-2 numbering ongkir"
                      placeholder="Ongkir" autocomplete="off" />
                  </div>
                </div>
              </div>
              ...
              <div class="row panelPembayaranLainnya hide">
                <div class="col-md-3 d-none">
                  <div class="form-group">
                    <input type="hidden" name="nominal_tunai" id="nominal_tunai"
                      class="form-control text-right numbering" placeholder="Nominal Tunai" />
                  </div>
                </div>
                <div class="col-md-3 d-none" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" name="nominal_hutang" id="nominal_hutang"
                      class="form-control text-right numbering" placeholder="Nominal Hutang" readonly />
                  </div>
                </div>
                <div class="col-md-1 d-none" style="padding-left:0px;">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <form action="#" class="form_barang" method="post">
                      <input type="text" class="form-control nama_barang" name="nama_barang"
                        placeholder="IMEI / Nama Barang" autocomplete="off" autofocus />
                    </form>
                  </div>
                </div>
              </div>
      ...
      <div class="row d-none" id="touchscreen">
        <div class="col-xs-12">
          <div class="row">
            <div class="col-md-2 logo mobile-none"><img
                src="<?php echo base_url('assets/images/logo-lingkaran.png'); ?>" alt="" style="height:100px"></div>
              ...
              <div class="row">
                <div class="col-md-6 col-xs-12">
                  <div class="row" style="margin: 0px 10px 0px 0px;">
                    <form class="form-inline">
                      <div class="form-group form-touch col-xs-4 p-0">
                        <span class="btn btn-primary btn-round btn-xs w-98" data-toggle="modal" data-target="#myModal2"
                          style="padding:4px;">
                          <label class="pull-right inline">
                            <xsall class="muted xsaller-90">Tambah Detail Penjualan <i
                                class="fa fa-angle-double-down"></i></xsall>
                      ...
                      <div class="form-group col-xs-4 p-0 pull-right" style="margin-bottom:0px">
                        <div id="panelDeadline" class="form-group btn-round w-98 panelDeadline" style="display:none;"
                          class="mT-10">
                          <div class="input-icon">
                            <input type="text" class="form-control btn-round w-98 deadline" id="deadline"
                              placeholder="Hari" value="" tabindex="5" maxlength="11" />
                  ...
                  <div class="col-xs-12 desktop-none">
                    <button type="button" class="btn btn-primary btn-produk no-border show-mobile" data-toggle="modal"
                      data-target="#modalProduk" data-id="" id="toggleProduk"><i class="fa fa-plus"></i> Produk</button>
                  </div>
                  ...
                  <div class="row" style="margin:0px">
                    <div class="col-md-9 col-xs-12 m-mB-10">
                      <button type="button" class="btn btn-primary btn-round no-border" id="btn_touch_ubah" data-id=""
                        data-toggle="modal" data-target="#myModal">Ubah</button>&nbsp;
                      <button type="button" class="btn btn-danger btn-round no-border" id="btn_touch_hapus"
                        data-id=""><i class="fa fa-trash"></i> Hapus</button>
                    </div>
                    <div class="col-md-3 col-xs-12">
                      <button type="button" id="id-btn-dialog3"
                        class="id-btn-dialog3 btn-block btn btn-primary btn-round no-border ">Selesai</button>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="modal-body">
                        <form class="form-horizontal">
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="mdl_touch_ubah_nama"
                                id="mdl_touch_ubah_nama" readonly />
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <div class="input-group"><input type="text" class="form-control"
                                  name="mdl_touch_ubah_kuantitas" id="mdl_touch_ubah_kuantitas">
                                <div class="input-group-addon numpad-qty numpad"><i class="fa fa-table"></i></div>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <div class="input-group"><input type="text" class="form-control"
                                  name="mdl_touch_ubah_harga" id="mdl_touch_ubah_harga" readonly />
                                <div class="input-group-addon numpad-qty numpad"><i class="fa fa-table"></i></div>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <div class="row">
                                <div class="col-sm-6"> % <div class="input-group"><input type="text"
                                      class="form-control"
                                      style="border-right-top-radius:0px;border-right-bottom-radius:0px;"
                                      name="mdl_touch_ubah_pot_persen" id="mdl_touch_ubah_pot_persen">
                                    <div class="input-group-addon numpad-potongan1"><i class="fa fa-table"></i></div>
                                  </div>
                                </div>
                                <div class="col-sm-6"> Potongan<div class="input-group"><input type="text"
                                      class="form-control" name="mdl_touch_ubah_pot" id="mdl_touch_ubah_pot">
                                    <div class="input-group-addon numpad-potongan2 numpad"><i class="fa fa-table"></i>
                                    </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="mdl_touch_ubah_total"
                                id="mdl_touch_ubah_total" readonly>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                              <button type="button" class="btn btn-primary btn-round no-border"
                                id="mdl_btn_submit">Submit</button>
                            </div>
                          </div>
                        </form>
                      </div>
                      <div class="modal-footer round-bottom">
                        <button type="button" class="btn btn-danger btn-round no-border"
                ...
                <div class="col-xs-6 col-xs-12 p-0 mobile-none" id="product-list_wrapper"
                  style="padding-right:25px;margin-bottom:50px">
                ...
                <div id="modalProduk" class="modal fade" role="dialog" style="overflow-y:auto">
                  <div class="modal-header"
                    style="background-color: #21a4f1;border-bottom: 3px solid #1b527f!important;padding:5px;font-size:13px!important">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="tutup()"><span
                  ...
                  <div class="modal-footer mdl-footer">
                    <button id="katToggle" class="btn btn-blue-dark btn-sm btn-popup"><i class="fa fa-exchange"></i>
                      Kategori</button>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-content" style="border-radius:30px">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-xs-3" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" class="form-control nama_pembeli2 input-2" id="nama_pembeli2" autocomplete="off"
                      value="<?php echo $nama_pembeli ?>" placeholder="Nama Pembeli" />
                  </div>
                </div>
                <div class="col-xs-3" style="padding-left:0px;">
              ...
              <div class="row">
                ...
                <div class="col-md-2 panelPembayaranLainnya hide" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" name="nominal_transfer"
                      class="form-control nominal_transfer text-right numbering input-2" placeholder="Nominal Transfer"
                      autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="col-md-2 panelSplit hide" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" name="nominal_split1" id="split_nominal_m"
                      class="form-control nominal-split input-2 nominal-split1 nominal_split1 nominal-split-m numbering"
                      placeholder="Nominal" />
                  </div>
                ...
                <div class="col-md-2 panelSplit nominal-split2 hide">
                  <div class="form-group">
                    <input type="text" name="nominal_split2" id="split2_nominal_m"
                      class="form-control input-2 nominal_split_2 number hide nominal-split2-form" placeholder="Nominal"
                      readonly />
                  </div>
                </div>
                ...
                <div class="col-md-2 panelSplitPembayaranLainnya hide" style="padding-left:0px;">
                  <div class="form-group">
                    <input type="text" name="nominal_split2" id="split3_nominal_m"
                      class="form-control input-2 nominal_split_2 number hide nominal-split2-form"
                      placeholder="Nominal Transfer" autocomplete="off" readonly />
                  </div>
                </div>
                <!-- /split -->
