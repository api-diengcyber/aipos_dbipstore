...
=======
              ...
              <div class="row m-switch">
                ...
                <!-- <div class="col-xs-2" style="padding-left:0px;padding-top:8px">
>>>>>>> 8b3e1523361b2613df3a6f94cecb8a3425bd1384
                    <div class="form-group">
        ...
        <div class="row d-none" id="touchscreen">
          <div class="col-xs-12">
                        ...
                        <div class="modal-body">
                          <form class="form-horizontal">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <div class="input-group"><input type="text" class="form-control" name="mdl_touch_ubah_kuantitas" id="mdl_touch_ubah_kuantitas">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <div class="input-group"><input type="text" class="form-control" name="mdl_touch_ubah_harga" id="mdl_touch_ubah_harga" readonly />
                                  <div class="input-group-addon numpad-qty numpad"><i class="fa fa-table"></i></div>
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <div class="row">
                                  <div class="col-sm-6"> % <div class="input-group"><input type="text" class="form-control" style="border-right-top-radius:0px;border-right-bottom-radius:0px;" name="mdl_touch_ubah_pot_persen" id="mdl_touch_ubah_pot_persen">
                                      <div class="input-group-addon numpad-potongan1"><i class="fa fa-table"></i></div>
                                    </div>
                                  </div>
                                  <div class="col-sm-6"> Potongan<div class="input-group"><input type="text" class="form-control" name="mdl_touch_ubah_pot" id="mdl_touch_ubah_pot">
            ...
            <<<<<<< HEAD <div id="myModal2" class="modal fade" role="dialog">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
        ...
        toggle.change(function() {
          ...
          >>> > 8 b3e1523361b2613df3a6f94cecb8a3425bd1384
          ...
          function insertTemp(barcode) {
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                } else if (response[0] == "1") {} else if (response[0] == "2") {
