        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
          <div class="row">
            <div class="col-md-6">
              ...
              <?php } else { ?>
                <div class="form-group">
                  ...
                  foreach ($data_kategori->result() as $key):
                    if ($key->id_kategori_2 == 1) {
                      ?>
                      <input type="hidden" name="kategori" id="kategori" readonly value="<?php echo $key->id_kategori_2 ?>">
                      <input type="text" class="form-control" readonly value="<?php echo $key->nama_kategori ?>">
              ...
              <div class="form-group">
                <label for="varchar">Nama Sparepart
                  <?php echo form_error('nama_produk') ?>
                </label>
                <input type="text" class="form-control" name="nama_produk" id="nama_produk" placeholder="Nama Sparepart"
