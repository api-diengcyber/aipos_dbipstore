	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="">Manajemen Sparepart</li>
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					...
					<!-- <?= $produk->nama_produk ? null : 'Daftar Produk' ?> -->
				</h1>
			</div><!-- /.page-header -->
				...
				<div class="col-xs-12">
					...
					<div class="row" style="margin-bottom: 10px">
						<div class="col-md-12 mb-4">
							...
							<?php echo anchor(site_url('admin/sparepart/create/' . $this->uri->segment(4)), $this->uri->segment(4) ? 'Tambah Varian' : 'Tambah Sparepart', 'class="btn btn-primary"'); ?>
					...
					<script type="text/javascript">
						...
						$(document).ready(function () {
							...
							var t = $("#mytable").dataTable({
								...
								serverSide: true,
								ajax: {
									"url": "<?php echo base_url() ?>admin/sparepart/json/<?php echo $this->uri->segment(4) ? $this->uri->segment(4) : '' ?>",
									"type": "POST",
									data: {
										kode: 1 // Mengambil nilai dari input dengan ID "kode"
									}
								},
								columns: [{
									"data": "id_produk_2",
