  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      ...
      <div class="row" style="margin-bottom: 10px">
        <div class="col-md-4">
          <button type="button" id="varian" class="btn btn-primary">Varian</button>
        </div>
      ...
      <form action="<?= $action2 ?>" method="post" enctype="multipart/form-data" autocomplete="off">
        <div class="row induk" style="display:none">
          <div class="col-md-12">
            <div class="form-group">
              <label for="">Pilih Produk</label>
              <select name="id_produk" id="" class="form-control" onchange='this.form.submit()'>
                <option value="">--Pilih Produk--</option>
                <?php foreach ($data_produk as $pr) { ?>
                  <option value="<?= $pr->id_produk_2 ?>">
                    <?= '| ' . $pr->barcode . ' |' . $pr->nama_produk . '| Deskripsi : ' . $pr->deskripsi ?>
                  </option>
                <?php } ?>
              </select>
            </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <center>
            ...
            <a href="<?php echo site_url('admin/pembelian_produk_langsung/create') ?>" class="btn btn-default">Cancel</a>
          </center>
        </div>
      </div>
      </form>
    <?php } else { ?>
      <?php if ($jml_kategori < 1) { ?>
        ...
        <a href="<?php echo base_url() ?>admin/kategori_produk_retail/create" class="btn btn-primary">Tambah
          Kategori</a>
      <?php } ?>
      <hr />
      <?php if ($jml_satuan < 1) { ?>
