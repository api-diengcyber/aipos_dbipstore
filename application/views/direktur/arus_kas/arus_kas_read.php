        ...
        <div class="col-xs-12">
          ...
          <table class="table">
            <tr>
              <td>Jenis Kas</td>
              <td>
                <?php echo ($id_kas == 1 ? 'Kas Masuk' : 'Kas Keluar'); ?>
              </td>
            </tr>
            <tr>
              <td>Tgl</td>
            ...
            <tr>
              <td>Nominal</td>
              <td>Rp.
                <?php echo number_format($nominal * 1, 0, ',', '.'); ?>
              </td>
            </tr>
            <tr>
              <td>Ket</td>
            ...
            <tr>
              <td></td>
              <td><button onclick="javascript:history.back();" type="button" class="btn btn-default">Cancel</button>
              </td>
            </tr>
          </table>
