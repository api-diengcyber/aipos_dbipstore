              ...
              <div class="col-md-12">
                ...
                <div style="margin-bottom:10px;">
                  <div class="row">
                      ...
                      ?>
                      <!-- <div class="infobox infobox-green infobox-large infobox-dark col-md-4">
                        <div class="infobox-data">
                          <div class="infobox-content">Stok <?php echo $key->nama_produk ?></div>
                          <div class="infobox-content"><h5><?php echo $key->stok ?></h5></div>
                        </div>
                      </div> -->
                      <?php endforeach; 
                       ?>
      ...
      $(document).ready(function(){
        function calc() {
          ...
          <?php foreach ($data_produk_stok as $key): ?>
            arr_stok[<?php echo $key->id_produk_2*1 ?>] = <?php echo $key->stok*1 ?>;
