          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <!-- <div class="form-group">
                ...
                <select name="" id="varian" style="border:transparent">
                  <option value="1">Bukan</option>
                  <option value="2">Iya</option>
                </select>

              </div>
              <div class="form-group parent hide">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="4" name="deskripsi" id="deskripsi"
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-xs-6" id="panel-jatuh-tempo" style="display: none;">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" name="jatuh_tempo" id="datepicker2" placeholder="dd-mm-yyyy"
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <!-- <div class="form-group">
                    ...
                    - Jika Jumlah melebihi mingros yang ditentukan, Harga admin akan otomatis menjadi Harga Reseller
                    Kecil.
                    <br>
                  </div> -->
                </div>
...
<script>
  $(document).ready(function () {
    ...
    $("#varian").change(function () {
      var selectedVarian = $(this).val();
      // alert(selectedVarian);
      if (selectedVarian == 1) {
