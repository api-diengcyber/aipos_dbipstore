  ...
  <div class="main-content-inner">
    <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
      <ul class="breadcrumb">
        ...
        <li class="active">Satuan Produk</li>
      </ul><!-- /.breadcrumb -->
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
              <?php echo anchor(site_url('admin/satuan_produk/create'), 'Tambah', 'class="btn btn-primary"'); ?>
            </div>
                ...
                <script type="text/javascript">
                  $(document).ready(function () {
                    ...
                    var t = $("#mytable").dataTable({
                      ...
                      processing: true,
                      serverSide: true,
                      ajax: { "url": "<?php echo base_url() ?>admin/satuan_produk/json", "type": "POST" },
                      columns: [
                        {
                          "data": "id_satuan",
                          "orderable": false
