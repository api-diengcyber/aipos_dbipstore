...
class Home extends AI_Admin
{
  ...
  {
    parent::__construct();
    $this->models('Kategori_produk_retail_model, Member_retail_model, Penjualan_retail_model, Pembelian_retail_model, Pegawai_retail_model, Piutang_retail_model, Faktur_retail_model,Mutasi_stok_model');
  }
