...
class Member_retail extends AI_Admin
{
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'kode' => $kode,
            'data_kode' => $this->get_kode_member()->result(),
        );
        $this->view('member/member_list', $data);
    }
    ...
    public function order_sales($id_member)
    {
        ...
        $this->view('member/order_sales', $data);
    }
    ...
    public function create()
    {
        ...
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('admin/member_retail/create_action'),
            'id' => set_value('id'),
            'id_toko' => $this->userdata->id_toko,
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('admin/member_retail/update_action'),
                ...
                'uid_akun' => set_value('uid_akun', $row->uid_akun),
                'data_sales' => $res_sales,
                'data_kota' => $this->db->get('kota')->result(),
                'data_akun' => $res_akun,
                'data_gudang' => $res_gudang,
    ...
    public function kartu_pelanggan()
    {
        ...
        $this->view('member/member_card', $data);
    }
    ...
    public function kartu_pelanggan_action()
    {
        ...
        $this->load->view('admin/member/cetak_member_card', $data, FALSE);
    }
    ...
    public function semua_order()
    {
        ...
        $this->view('member/semua_order', $data);
    }
    ...
    public function semua_order_detail($id)
    {
        ...
        $this->view('member/semua_order_detail', $data);
    }
